...
#[derive(Debug)]
pub struct WebContractProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WebContractProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebContract processing");
    
    let mut processor = WebContractProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebContractProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebContractProcessor::new(false);
